...
<nav class="menu clearfix">
    <dl class="menu-item"><a ajax-get data-action="<?php echo UU('dslist/dslist?ds=need');?>##need">
...
<section class="body container">
    ...
    <ul class="body-list ">
        <li><div class="list-cont-01"><a ajax-get data-action="<?php echo UU('dslist/publish');?>"><h3 class="cont-tit">发布需求</h3><h3 class="cont-des">我们帮你找材料</h3></a></div> </li>
        <li><div class="list-cont-03"><a ajax-get data-action="<?php echo UU('dslist/publish');?>"><h3 class="cont-tit">发布供应</h3><h3 class="cont-des">我们只推好产品</h3></a></div> </li>
    </ul>
    <ul class="body-list">
    ...
    <ul class="product-list">
        <li class="clearfix " ng-repeat="x in newList">
            <div class="pro-right pull-right">
                <button ajax-get type="button" class="tigo-btn gz" data-action='<?php echo U("user/favorite/do_dsfav");?>&id={{x.id}}' data-html="已关注" data-ng-click="submit()" ng-bind="x.attention"></button>
		...
		<li>
        <a href="<?php echo U('portal/dslist/dslist');?>" style="padding: .6rem; display: block; text-align: center; font-size: .8rem;">查看更多</a></li>
    </ul>
</section>
<footer class="footer">
