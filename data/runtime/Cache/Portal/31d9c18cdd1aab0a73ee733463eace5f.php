	...
	<div class="wrap js-check-wrap">
		...
		<form class="js-ajax-form" action="" method="post">
			...
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($sample)): foreach($sample as $key=>$vo): ?><tr>
					...
					<td>
						<a href="<?php echo U('AdminDslist/detail',array('id'=>$vo['id']));?>">详情</a> | 
						<?php if($vo['post_status'] == 1): ?><a href="<?php echo U('AdminDslist/cancel',array('id'=>$vo['id']));?>" data-msg="确认要取消审核吗？">取消审核</a> | 
						<?php else: ?> <a href="<?php echo U('AdminDslist/adjust',array('id'=>$vo['id']));?>" data-msg="确认要审核吗？">审核</a> |<?php endif; ?>
						<a href="<?php echo U('AdminDslist/delete',array('id'=>$vo['id'],'tid'=>$vo['term_id']));?>" class="js-ajax-delete">删除</a></td>
