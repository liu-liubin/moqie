		...
		<form method="post" class="js-ajax-form">
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<?php $company_statuses=array("1"=>'未审核',"2"=>'请求审核',"3"=>'审核失败',"4"=>'审核成功'); ?>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
						...
						<td><?php echo ($company_statuses[$vo['company_status']]); ?></td>
						<td align="center">
							<a href="<?php echo U('indexadmin/userinfo',array('id'=>$vo['id']));?>"  >详情</a>|

							<?php if($user['company_status'] == 1): ?><font color="#cccccc">审核 |</font>
							<?php elseif($user['company_status'] == 2): ?><a href="<?php echo U('indexadmin/adjust',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="<?php echo L('你确定要审核该用户吗？');?>">审核</a>|
							<?php elseif($user['company_status'] == 3): ?><a href="<?php echo U('indexadmin/adjust',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="<?php echo L('你确定要审核该用户吗？');?>">审核</a>|
							<?php else: ?> <font color="#cccccc">审核 |</font><?php endif; ?>
