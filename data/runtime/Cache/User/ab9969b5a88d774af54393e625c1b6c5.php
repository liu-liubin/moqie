...
<div class="info-wrapper">
    <ul class="wm-list">
        ...
        <li>手机<span style="color:rgb(232,119,41);">（必填）</span> <img class="icon pull-right" src="/public/images/prev2.png"/><div class="pull-right"><?php echo ($user["mobile"]); ?>&nbsp;&nbsp;</div></li>
    ...
    <a class="wm-btn btn-danger" href="<?php echo U('user/center/reg_company');?>" style="margin-top: .6rem;">继续完善企业信息</a>
    <a class="wm-btn btn-danger" href="<?php echo U('portal/mine/index');?>" style="margin-top: .6rem;background: #fff;border: solid 1px #E9000D;color:#E9000D;">跳过企业信息完善</a>
    </div>
