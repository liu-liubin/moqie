	...
	<div class="container tc-main">
		<div class="row">
			<div class="span4 offset4">
				...
				<form class="form-horizontal js-ajax-form" action="<?php echo U('user/login/dopassword_reset');?>" method="post">
					<div class="control-group">
						<input type="password" id="input_password" name="password" class="span4" placeholder="密码">
					</div>

					<div class="control-group">
						<input type="password" id="input_repassword" name="repassword" class="span4" placeholder="重复密码">
					</div>
...
<div id="footer">
	...
	<p>
		Made by <a href="http://www.tigonetwork.com" target="_blank">TIGO</a>
